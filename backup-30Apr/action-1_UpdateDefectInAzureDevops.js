...
exports.handler = async function ({ event, constants, triggers }, context, callback) {
  try {
    ...
    const curAssignedTo = norm(cur[constants.AzDoAssignedToFieldRef] || "");
    ...
    // if (userName) {
    //   console.log("[Info] Updating User Email:", { from: curAssignedTo.displayName || "(empty)", to: assignedToLabel });
    //   patchData.push({ op: "add", path: `/fields/${constants.AzDoAssignedToFieldRef}`, value: userName });
    // }
...
>>>>>>> 7da1abbd7f0f8fe339ed72bf1c79694fa04d4bee
